  ...
  if (analyticsBox) {
    ...
    analyticsBox.innerHTML = `
      <div class="analytics-header">
        <span><img src="images/icons/leaf-1.png" style="width: 16px; height: 16px; vertical-align: middle;" alt="Leaf"> نشاط استماعك مع ${data.shortName}</span>
        <span style="color: ${data.accentColor}; font-size: 12px; font-weight: 800;">إحصائيات حية</span>
      </div>
